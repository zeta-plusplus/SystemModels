...
model StirlingEngine01_test01
  ...
  Modelica.Mechanics.Translational.Components.Mass mass1(L = 0.02, m = 1, s(fixed = true, start = 0.1))  annotation(
...
equation
  ...
  __OpenModelica_simulationFlags(lv = "LOG_STATS", outputFormat = "plt", s = "dassl"));end StirlingEngine01_test01;
