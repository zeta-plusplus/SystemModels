...
model CollidingPendulum_001
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape(angles_fixed = false,angles_start(displayUnit = "deg") = {0.5235987755982988, 0, 0}, color = {255, 0, 0},length = bodyShape.r[1], m = 1, r = {0.5, 0, 0}, r_CM = bodyShape.r, sphereDiameter = 0.05, width = 1 / 10 * bodyShape.sphereDiameter) annotation(
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape1(angles_fixed = false, angles_start(displayUnit = "deg") = {0.5235987755982988, 0, 0}, length = bodyShape1.r[1], m = 1, r = {0.5, 0, 0}, r_CM = bodyShape1.r, sphereDiameter = 0.05, width = 1 / 10 * bodyShape1.sphereDiameter) annotation(
  ...
  Modelica.Mechanics.Translational.Components.ElastoGap elastoGap(c = 1e15, d = 0.001, s_rel0 = 0 +bodyShape.sphereDiameter / 2 + bodyShape1.sphereDiameter / 2) annotation(
    Placement(visible = true, transformation(origin = {0, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Forces.LineForceWithMass lineForceWithMass(animateLine = false, animateMass = false, m = 0.01)  annotation(
  ...
  Modelica.Mechanics.Rotational.Components.Damper damper1(d = 0.01, phi_rel(displayUnit = "rad"))  annotation(
