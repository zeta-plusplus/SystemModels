...
model test_reactor_04
  ...
  Modelica.Fluid.Machines.ControlledPump pump(redeclare package Medium = liquid1, N_nominal = 10000, control_m_flow = true, m_flow_nominal = 10, m_flow_start = pump.m_flow_nominal, p_a_nominal =  101.3 * 1000, p_b_nominal = 10 *101.3 * 1000, use_m_flow_set = false)  annotation(
    Placement(visible = true, transformation(origin = {-20, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
  connect(ramp2.y, pump.m_flow_set) annotation(
    Line(points = {{-68, -90}, {-46, -90}, {-46, -96}, {-28, -96}, {-28, -96}}, color = {0, 0, 127}));
