...
model test_reactor_01
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary1(redeclare package Medium = liquid1, T = 273.15 + 400, nPorts = 1, p = 5 * 101.3 * 1000) annotation(
...
equation
  connect(pointKineticMoltenSaltReactor1.port_b, volume.heatPort) annotation(
    Line(points = {{-31, -23}, {-31, -24}, {-25, -24}, {-25, -61}, {-21, -61}}, color = {191, 0, 0}));
  connect(add31.y, pointKineticMoltenSaltReactor1.rho) annotation(
    Line(points = {{-70, -1}, {-70, -24}, {-49, -24}, {-49, -23}}, color = {0, 0, 127}));
