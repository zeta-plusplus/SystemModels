...
model ptMassDynamics001
  ...
  Modelica.Mechanics.MultiBody.Parts.PointMass body1(
    m=1,
    r_0(fixed = true,start={0, 10,0}),
    sphereDiameter=0.1,
    v_0(fixed = true,start={10, 10, 0}))
    annotation (Placement(visible = true, transformation(extent = {{20, 60}, {40, 80}}, rotation = 0)));
...
equation
  connect(ramp1.y, force.force[2]) annotation(
    Line(points = {{-58, 10}, {-46, 10}, {-46, 30}, {-32, 30}, {-32, 30}}, color = {0, 0, 127}));
  connect(const1.y, force.force[3]) annotation(
    Line(points = {{-58, -20}, {-38, -20}, {-38, 30}, {-32, 30}, {-32, 30}}, color = {0, 0, 127}));
  connect(const.y, force.force[1]) annotation(
    Line(points = {{-58, 40}, {-40, 40}, {-40, 30}, {-32, 30}, {-32, 30}}, color = {0, 0, 127}));
